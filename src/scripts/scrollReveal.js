...
//     sr.reveal('.about-section .socials .social', { origin: 'bottom', interval: 60 });
...
//     // Projects
//     sr.reveal('.projects-section .project-card', { origin: 'bottom', interval: 200 });

//     // Contact
//     sr.reveal('.contact-section .subtitle', { origin: 'bottom' });
//     sr.reveal('.contact-section .input-group, .contact-section .textarea-group, .contact-section .form-btn', {
//         origin: 'bottom',
//         interval: 80
//     });
